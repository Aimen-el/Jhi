package com.lean.bibleo.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("bibleo");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("bibleo");
        ...
        config.getMapConfigs().put("com.lean.bibleo.domain.*", initializeDomainMapConfig(jHipsterProperties));
