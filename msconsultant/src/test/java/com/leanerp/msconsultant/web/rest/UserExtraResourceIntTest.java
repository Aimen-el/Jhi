...
import com.leanerp.msconsultant.repository.UserExtraRepository;
...
import static com.leanerp.msconsultant.web.rest.TestUtil.createFormattingConversionService;
...
public class UserExtraResourceIntTest {
    ...
    public void createUserExtra() throws Exception {
        ...
        assertThat(testUserExtra.getTelephone()).isEqualTo(DEFAULT_TELEPHONE);
    }
    ...
    public void updateUserExtra() throws Exception {
        ...
        UserExtra testUserExtra = userExtraList.get(userExtraList.size() - 1);
        assertThat(testUserExtra.getTelephone()).isEqualTo(UPDATED_TELEPHONE);
    }
