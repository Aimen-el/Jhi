    ...
    describe('Extra Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'consultant/api/extras';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Extra', () => {
                service.create(new Extra(null)).subscribe(received => {
            ...
            it('should update a Extra', () => {
                service.update(new Extra(123)).subscribe(received => {
